...
$response = array(
  ...
  "concreteQuantity" => round($cobj->getVolOfFoundation(), 2),
  "reinforcementQuantity" => round($cobj->getVolOfFoundation(), 2),
  "formworksQuantity" => round($cobj->getVolOfFoundation(), 2),
