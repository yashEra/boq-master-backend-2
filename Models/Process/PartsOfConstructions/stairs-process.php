...
$response = array(
  ...
  "concreteCost" => round($stairsobj->concreteRate(), 2),
  "reinforcementCost" => round($stairsobj->rainforcementRate(), 2),
  "formworksCost" => round($stairsobj->formworkRate(), 2),
  "concreteQuantity" => round(($stairsobj->getStairsTotVol() + $stairsobj->getStairsCaseVol()), 2),
  "reinforcementQuantity" => round(($stairsobj->getStairsTotVol() + $stairsobj->getStairsCaseVol()), 2),
  "formworksQuantity" => round($stairsobj->getStairsCaseArea(), 2),
